...
def one_year_of_war():
    ...
    tank = Tank("Танк Пётр") #танк
    attacker = Attacker("Убийца Ольга") #злоумышленник
    second_attacker = Attacker("Убийца Траур")
    healer = Healer("Монах Игнат") #Целитель
    second_healer = Healer("Монах Ирэна")
    good_team = [tank, attacker, second_attacker, second_healer, healer] #хорошая команда
    ...
    evil_names = ["Абвыргл", "Мефисто", "Драник", "Диабло", "Пусечка", "Стаут"] #злые имена
